...
public class LevelCompleteUI : MonoBehaviour {
    ...
    public void ShowLevelComplete() {
        ...
        if (enemiesKilledText) {
            enemiesKilledText.text = "Enemigos Eliminados: " + ScoreManager.Instance.GetEnemiesKilled();
        }
        if (damageDealtText) {
            damageDealtText.text = "Daño Infligido: " + ScoreManager.Instance.GetTotalDamageDealt();
        }
        if (damageTakenText) {
            damageTakenText.text = "Daño Recibido: " + ScoreManager.Instance.GetTotalDamageTaken();
        }
